<form action="<?php echo admin_url(); ?>" method="POST">
	...
	<nav><a href="<?php echo esc_url(admin_url('options-general.php?page=sublanguage-settings')); ?>"><?php echo esc_html__('Sublanguage General Settings', 'sublanguage'); ?></a></nav>
