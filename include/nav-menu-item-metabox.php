...
<table>
	<tbody>
		...
		<?php } else if (isset($url)) { ?>
			<tr><td><label><?php echo __('URL'); ?></label></td><td><input type="text" name="sublanguage_extra_cpt[_menu_item_url]" value="<?php echo $url; ?>"/></td></tr>
		<?php } ?>
